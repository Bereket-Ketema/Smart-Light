...
def get_brightness():
    ...
    return success_response("Brightness retrieved", {"brightness": brightness})
...
def post_sensitivity():
    ...
    return success_response("Sensitivity updated", {"sensitivity": updated["sensitivity"]})
...
def get_sensitivity():
    ...
    return success_response("Sensitivity retrieved", {"sensitivity": sensitivity})
...
def post_timer():
    ...
    return success_response("Auto-off timer updated", {"timer": updated["timer"]})
...
def get_timer():
    ...
    return success_response("Timer retrieved", {"timer": timer})